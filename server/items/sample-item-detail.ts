...
export function buildSampleItemDetail(): ItemDetail {
  return {
    ...
    facts: [
      ...
      {
        field: 'packaging.length_cm',
        value: 20,
        confidence: 0.8,
        origin: 'image_inference',
        evidence: 'A Sony WH-1000XM4 folds to roughly 20x18x8cm -- consistent with the photos',
        retrievedAt: '2026-09-02T14:26:00.000Z',
      },
      {
        field: 'packaging.width_cm',
        value: 18,
        confidence: 0.8,
        origin: 'image_inference',
        evidence: 'A Sony WH-1000XM4 folds to roughly 20x18x8cm -- consistent with the photos',
      ...
      {
        field: 'packaging.weight_kg',
        value: 0.25,
        confidence: 0.75,
        origin: 'image_inference',
        evidence: 'Typical weight for this model, no scale visible in photos',
        retrievedAt: '2026-09-02T14:26:00.000Z',
      },
      {
        ...
        confidence: 0.7,
        origin: 'image_inference',
        evidence: 'Folding hinge and ear cushions warrant some padding, no glass or exposed electronics',
        retrievedAt: '2026-09-02T14:26:00.000Z',
      },
    ],
    phases: [
    ...
    postage: {
      ...
      quotes: [
        {
          courier: 'Evri Drop-off',
          service: 'Evri ParcelShop to ParcelShop',
          priceGbp: 2.39,
          dropOff: true,
          locker: false,
          collection: false,
          printerNeeded: false,
          estDeliveryDateMin: '2026-09-10T00:00:00.000Z',
          estDeliveryDateMax: '2026-09-11T00:00:00.000Z',
          maxWeightKg: 15,
        },
        {
          courier: 'InPost',
          service: 'InPost Lockers to Home',
          priceGbp: 3.23,
          dropOff: false,
          locker: true,
          collection: false,
          printerNeeded: false,
          estDeliveryDateMin: '2026-09-10T00:00:00.000Z',
          estDeliveryDateMax: '2026-09-14T00:00:00.000Z',
          maxWeightKg: 15,
        },
        {
          courier: 'Evri Collection',
          service: 'Evri Collection',
          priceGbp: 3.96,
          dropOff: false,
          locker: false,
          collection: true,
          printerNeeded: true,
          estDeliveryDateMin: '2026-09-09T00:00:00.000Z',
          estDeliveryDateMax: '2026-09-11T00:00:00.000Z',
          maxWeightKg: 15,
        },
      ],
      dropOffPoints: [
        {
          name: '24/7 InPost Locker - Your Co-op Grove',
          address: 'Unit 1 Savile Way',
          postcode: 'OX12 0PT',
          distanceMiles: 0.2,
          isLocker: true,
          printInStoreAvailable: false,
          networks: ['InPost'],
        },
        {
          name: 'Grove Post Office',
          address: '1 High Street',
          postcode: 'OX12 0PT',
          distanceMiles: 0.4,
          isLocker: false,
          printInStoreAvailable: true,
          networks: ['Royal Mail', 'Parcelforce'],
        },
        {
          name: 'Post Office Wantage',
          address: '18 Wallingford Street',
          postcode: 'OX12 8AX',
          distanceMiles: 1.1,
          isLocker: false,
          printInStoreAvailable: true,
